...
//FIX THIS so that it returns the actual voltage\
        return  resistanceVal*currentVal;
    }
...
//is between 50 and -50, otherwise print an error message.
    ...
    currentVal = voltage/resistanceVal;
    }
...
//FIX THIS
        return currentVal * resistanceVal * currentVal;
    }
