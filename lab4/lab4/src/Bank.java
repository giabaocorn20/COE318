...
public class Bank {
    ...
    public boolean add(Account account) {
        if (hasAccountNumber(account.getNumber()) || numAccounts == accounts.length) {
            //System.out.println("Account number already exists or bank is full");
            return false;
        }
        else {
            accounts[numAccounts] = account; //add account to array numAccounts = 0
            numAccounts++; //increment numAccounts
            return true;
        }
    }
